...
Here, we apply compound-specific isotope analysis (CSIA) of individual essential amino acids (AA<sub>ESS</sub>) to examine autochthonous (algae) and allochthonous (terrestrial-plant) energy channels to alpine lake zooplankton.
