...
AlldataPredict <- data.frame(Group = prod$Group, SampleID = prod$ID, predict(All.train)$x)
...
MSiar.data.env<- MSiar.data.env %>%
  dplyr::select("Location", "Date", "Lake", "elevation", "latitude", "longitude", "depth..ft",
                "secchi..ft", "temp..C", "DO..perc", "spc", "pH", "DOC..mg.L",
                "TN..ug.L", "TP..ug.L", "chla", "SampleID", "orig.class", "phy.group", 
                "Ile", "Leu", "Phe", "Thr", "Val",
...
mod.df<- MSiar.data.env %>%
  dplyr::select(SampleID, Lake, elevation, depth..ft, temp..C, DO..perc, pH, DOC..mg.L,
                TN..ug.L, TP..ug.L, chla, phy.group, LD.class, LD1, Source, Mean, SD)
