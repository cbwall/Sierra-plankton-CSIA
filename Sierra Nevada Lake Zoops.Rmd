...
API<-read.csv("data/API_key.csv") # can we put the API_key.csv in the data folder? I don't see it, if not, let's remove this chunk of code from our .Rmd file in GitHub becasue it's not reproducible?
API.key<-API[1,1]
