...
isospace_plot <- plot_data(filename = "output/MixSIAR_isospace_plot_SampleIDs",
...
#readRDS(file = "output/MixSIAR_models/SampleID_models/MixSIAR_Model_SampleID_rjags.rds")
...
SAMP.mixSIAR.1.output <- read.table("output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_summary_stats_a_posteriori.txt",
