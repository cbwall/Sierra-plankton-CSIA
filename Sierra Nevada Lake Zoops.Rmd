...
Plant.nut.env<- mod.data[(mod.data$Source=="Plants"),]
Plant.nut.env <- Plant.nut.env %>% 
       dplyr::rename("Prop.plant" = "Mean")
  

POM.nut.env<- mod.data[(mod.data$Source=="POM"),]
POM.nut.env <- POM.nut.env %>% 
       dplyr::rename("Prop.pom" = "Mean")

# models for prop.plants
mod1<-lm(Prop.plant~elevation..m, data=Plant.nut.env); anova(mod1) # no relationship
mod2<-lm(Prop.plant~depth..m, data=Plant.nut.env); anova(mod2) # no relationship
mod3<-lm(Prop.plant~temp..C, data=Plant.nut.env); anova(mod3) # no relationship
mod4<-lm(Prop.plant~DO..perc, data=Plant.nut.env); anova(mod4) # no relationship
mod5<-lm(Prop.plant~pH, data=Plant.nut.env); anova(mod5) # no relationship
mod6<-lm(Prop.plant~TN..ug.L, data=Plant.nut.env); anova(mod6) # SIGNIFICANT!
mod7<-lm(Prop.plant~TP..ug.L, data=Plant.nut.env); anova(mod7) # SIGNIFICANT!
mod8<-lm(Prop.plant~chla..ug.L, data=Plant.nut.env); anova(mod8) # no relationship
mod9<-lm(Prop.plant~DOC..mg.L, data=Plant.nut.env); anova(mod9) # SIGNIFICANT!


# models for prop.plants
mod1<-lm(Prop.pom~elevation..m, data=POM.nut.env); anova(mod1) # no relationship
mod2<-lm(Prop.pom~depth..m, data=POM.nut.env); anova(mod2) # no relationship
mod3<-lm(Prop.pom~temp..C, data=POM.nut.env); anova(mod3) # no relationship
mod4<-lm(Prop.pom~DO..perc, data=POM.nut.env); anova(mod4) # no relationship
mod5<-lm(Prop.pom~pH, data=POM.nut.env); anova(mod5) # no relationship, but p=0.2
mod6<-lm(Prop.pom~TN..ug.L, data=POM.nut.env); anova(mod6) # SIGNIFICANT!
mod7<-lm(Prop.pom~TP..ug.L, data=POM.nut.env); anova(mod7) # SIGNIFICANT!
mod8<-lm(Prop.pom~chla..ug.L, data=POM.nut.env); anova(mod8) # no relationship
mod9<-lm(Prop.pom~DOC..mg.L, data=POM.nut.env); anova(mod9) # SIGNIFICANT!

### clearly copepods have much stronger variance... why?
copep.plant<-Plant.nut.env[(Plant.nut.env$phy.group=="copepoda"),]
cladoc.plant<-Plant.nut.env[(Plant.nut.env$phy.group=="cladocera"),]

# models for prop.plants, copepoda
mod1<-lm(Prop.plant~elevation..m, data=copep.plant); anova(mod1) # no relationship
mod2<-lm(Prop.plant~depth..m, data=copep.plant); anova(mod2) # no relationship
mod3<-lm(Prop.plant~temp..C, data=copep.plant); anova(mod3) # no relationship
mod4<-lm(Prop.plant~DO..perc, data=copep.plant); anova(mod4) # no relationship
mod5<-lm(Prop.plant~pH, data=copep.plant); anova(mod5) # no relationship
mod6<-lm(Prop.plant~TN..ug.L, data=copep.plant); anova(mod6) # TREND >>
mod7<-lm(Prop.plant~TP..ug.L, data=copep.plant); anova(mod7) # TREND >>
mod8<-lm(Prop.plant~chla..ug.L, data=copep.plant); anova(mod8) # TREND
mod9<-lm(Prop.plant~DOC..mg.L, data=copep.plant); anova(mod9) # TREND >


# models for prop.plants, cladocera
mod1<-lm(Prop.plant~elevation..m, data=cladoc.plant); anova(mod1) # no relationship
mod2<-lm(Prop.plant~depth..m, data=cladoc.plant); anova(mod2) # no relationship
mod3<-lm(Prop.plant~temp..C, data=cladoc.plant); anova(mod3) # no relationship
mod4<-lm(Prop.plant~DO..perc, data=cladoc.plant); anova(mod4) # no relationship
mod5<-lm(Prop.plant~pH, data=cladoc.plant); anova(mod5) # TREND
mod6<-lm(Prop.plant~TN..ug.L, data=cladoc.plant); anova(mod6) # no relationship
mod7<-lm(Prop.plant~TP..ug.L, data=cladoc.plant); anova(mod7) # no relationship
mod8<-lm(Prop.plant~chla..ug.L, data=cladoc.plant); anova(mod8) # no relationship
mod9<-lm(Prop.plant~DOC..mg.L, data=cladoc.plant); anova(mod9) # no relationship
...
Zoop.NMDS<-na.omit(Plant.nut.env)

# factors
Zoop.NMDS.fac<- Zoop.NMDS %>%
  dplyr::select(Lake, phy.group)

Zoop.NMDS.dat<- Zoop.NMDS %>%
  dplyr::select(Ile, Phe, Thr, Val, Prop.plant)

Env.NMDS.dat<- Zoop.NMDS %>%
  dplyr::select(temp..C, DO..perc, pH, DOC..mg.L, TN..ug.L, TP..ug.L, chla..ug.L)
