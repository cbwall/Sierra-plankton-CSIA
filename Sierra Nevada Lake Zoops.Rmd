...
#### MixSIAR Model 1: by sampleID
Now import data and create model structure.
```{r mixsiar 1 by sample, eval=FALSE, echo=TRUE, collapse=TRUE}
...
isospace_plot <- plot_data(filename = "output/MixSIAR_isospace_plot_SampleIDs", plot_save_pdf = TRUE, plot_save_png = FALSE,
                           cons, source, discr)
...
# PROCESS ERROR ONLY - HAVE TO DO THIS WHEN RUNNING MIXTURE POINTS INDIVIDUALLY
  model_filename <- "output/MixSIAR_models/SampleID_models/MixSIAR_Model_1_SampleID_fixed.txt"
  resid_err <- FALSE
  process_err <- TRUE
  write_JAGS_model(model_filename, resid_err, process_err, cons, source)
...
#Process diagnostics, summary stats, and posterior plots
  output_JAGS(zoop.jags.mod, cons, source, output_options = list(
    summary_save = TRUE,                   
    summary_name = "output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_summary_stats",
    sup_post = FALSE,                       
    plot_post_save_pdf = TRUE,              
    plot_post_name = "output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_posterior_density",   
    sup_pairs = TRUE,                       
    plot_pairs_save_pdf = TRUE,             
    plot_pairs_name = "output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_pairs_plot",         
    sup_xy = TRUE,                          
    plot_xy_save_pdf = TRUE,                
    plot_xy_name = "output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_xy_plot",             
    gelman = TRUE,                         
    heidel = FALSE,                         
    geweke = TRUE,                         
    diag_save = TRUE,                       
    diag_name = "output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_diagnostics",
    indiv_effect = FALSE,
    plot_post_save_png = FALSE,            
    plot_pairs_save_png = FALSE,            
    plot_xy_save_png = FALSE))
...
#save all results
save.image("output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_fixed_data.RData")

```

```{r mixsiar 1 by sample output, eval=FALSE, echo=TRUE, fig.keep='none'}

############################
# EVALUATE MixSIAR MODEL 1 #
############################
...
SAMP.mixSIAR.1.output <- read.table("output/MixSIAR_models/SampleID_models/MixSIAR_1_SampleID_summary_stats.txt",
...
write.csv(Samp.out.cleaned, "output/MixSIAR_1_Samp.df.csv", row.names = FALSE)

```

#### MixSIAR Models 2 and 3: Zooplankton Group and Zooplankton Group by Lake
...
```{r mixSIAR data complete, eval=FALSE, echo=TRUE, fig.keep='none'}
...
```{r complete mixsiar model comparison, eval=FALSE, echo=TRUE, fig.keep='none'}

##########################
# Compare MixSIAR Models #
##########################
setwd(mainDir)
...
```{r read complete mixsiar summary, eval=FALSE, echo=TRUE, fig.keep='none'}
