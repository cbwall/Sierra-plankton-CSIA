...
# run a full model
mod.mult<-lm(Prop.plant~elevation..m+temp..C+pH+TN..ug.L+TP..ug.L+chla..ug.L+DOC..mg.L,
             data=Plant.nut.env)
...
mod.mult.copepod<-lm(Prop.plant~elevation..m+temp..C+pH+TN..ug.L+TP..ug.L+chla..ug.L+DOC..mg.L,
             data=copep.plant)
...
# best model is with temp..C (p=0.229) and TN (p=0.041), R2-adjust = 0.33, RSE= 0.096
...
# run a full model, but 3 not defined because of singularities
mod.mult.cladoc<-lm(Prop.plant~elevation..m+temp..C+pH+TN..ug.L+TP..ug.L+chla..ug.L+DOC..mg.L,
             data=cladoc.plant)
...
# best model is with pH alone (p=0.081) R2-adjust = 0.25, RSE= 0.092
...
# this is best model for mutiple regression, RSE 0.099, R2-adjust =0.186
mod.mult<-lm(Prop.plant~elevation..m+(TN..ug.L)+chla..ug.L+DOC..mg.L,
             data=cladoc.plant)
summary(mod.mult)
