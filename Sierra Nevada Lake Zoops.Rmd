...
### export it
pdf(file= "figures/Fig x.Phy.mixsiar.pdf", height=5, width=5)
mod3.phy.fig
dev.off()
...
### export it
pdf(file= "figures/Fig x.Lake.mixsiar.pdf", height=7, width=12)
mod3.lake.fig
dev.off()
```
...
### export it
pdf(file= "figures/Fig x.PCA.norm.lake plot2.pdf", height=7, width=12)
