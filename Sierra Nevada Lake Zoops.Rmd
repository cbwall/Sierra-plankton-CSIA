...
set.seed(500)
EAA.perm.SOURCE<-adonis2(ESS.sources.dat.abs~ Group, data=Source.fac, permutations=999, method="euclidian")
EAA.perm.SOURCE # not-different, p=0.002
...
# 2 PCs explaiin 96% of variation, most in 1 axis (93%)
