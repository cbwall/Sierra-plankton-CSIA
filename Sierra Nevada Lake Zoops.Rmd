...
pacman::p_load('knitr', 'lme4', 'lmerTest', 'tidyverse', 'effects', 'plyr', 'dplyr', 'plotrix', 'car',"gridExtra", "cowplot", "tools", "mgcv", "gratia", "MASS", "stats", "tidymv", "sjstats", "coin", "emmeans", "ggplot2", "mda", "nortest", "reshape2", "gmm", "propagate","ggmap", "RgoogleMaps", "MixSIAR","GGally", "ggbiplot", "ggcorrplot")
...
LDA.phy.boxplot
dev.copy(pdf, "figures/Fig3.LDA.phy.boxplot.pdf", width = 6, height = 6)
dev.off()
...
### export it
pdf(file= "figures/Fig4.Phy.mixsiar.pdf", height=5, width=5)
mod3.phy.fig
dev.off()
...
### export it
pdf(file= "figures/Figx.Plant.prop.mod.pdf", height=22, width=8)
prop.plant.mod.fig
dev.off()
```
...
### export it
pdf(file= "figures/Figx.PCA.lake plot.pdf", height=8, width=8)
PCA.lake.plank
dev.off()
...
### export it
pdf(file= "figures/Fig5.PCA.norm.lake plot2.pdf", height=7, width=12)
