...
How are these PERMANOVA's used? should they be on a scaled and centered matrix? Should this be done after PCA?
...
# Plants differ from POM (p=0.005), plants almost significant from Zooplankton (p=0.086)
```

Just with producers only
```{r permanova 2, eval=FALSE}
####################
...
```{r PCA zoops normEAA, eval=FALSE}
