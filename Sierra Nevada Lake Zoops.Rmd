...
############# need work to edit this, order the lakes by their relative elevation
LDA.plot.phy<-ggplot(LDA.df, aes(x=LD1, y=Lake, 
                                 color = Lake),
                                 shape=phy.group)+
  geom_point(size=3)+
  geom_vline(xintercept=-0.75, linetype="dashed", color = "gray60")+
...
LDA.plot.phy
dev.copy(pdf, "figures/LDA.plot.phy.pdf", width = 8, height = 6)
dev.off()
