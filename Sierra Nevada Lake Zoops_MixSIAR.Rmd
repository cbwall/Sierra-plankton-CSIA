...
# https://urldefense.com/v3/__https://developers.google.com/maps/documentation/maps-static/styling*features__;Iw!!Mih3wA!BY88Nu5HbyhcuJqyCDdu01uScF_zg_-tJoEHzZuFgyK1ZmiXaI28QgU96bMzJx_aGVvIwQd0nBmqanfHGw$ 
...
write.csv(SNL.d13C.aa, "data/Sierra Nevada Lakes AA d13C Data NMX standard.csv")
...
density_LDA<-ggplot(data=LDA.df.el, aes(x=LD1, group=phy.group, fill=phy.group)) +
    ...
    scale_fill_manual(values=c("plum4", "orange","coral", "springgreen4", "dodgerblue"))+ 
  theme_classic()

density_LDA
dev.copy(pdf, "figures/LDA_density.pdf", width = 6, height = 4)
dev.off()


####### Ridgeline plot

density.ridge<-ggplot(LDA.df.el, aes(x = LD1, y = orig.class, fill = after_stat(x))) +
  geom_density_ridges_gradient(scale = 1, rel_min_height = 0.04) +
...
density.ridge
dev.copy(pdf, "figures/LDA_ridge.pdf", width = 6, height = 4)
dev.off()
```
